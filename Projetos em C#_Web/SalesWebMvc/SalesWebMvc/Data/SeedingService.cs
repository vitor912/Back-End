...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Bob Brown", "bob@hotmail.com", new DateTime(1998, 4, 21), 5000.0, d3);
            Seller s4 = new Seller(4, "Mary Jane", "mary_jane@hotmail.com", new DateTime(1985, 11, 30), 5000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donals_blu@gmail.com", new DateTime(1986, 11, 20), 1500.0, d4);
            Seller s6 = new Seller(6, "Alex Grey", "alegrey@gmail.com", new DateTime(2000, 1, 5), 1500.0, d1);
